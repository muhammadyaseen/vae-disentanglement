...
scp muhammad1@juwels-booster.fz-juelich.de:/p/project/hai_cs_vaes/vae-disentanglement/train-logs/GNN_CS_VAE_dsprites_correlated_structure_test_cont/version_0/checkpoints/epoch=52-step=610560.ckpt ./
# Then to Cispa
